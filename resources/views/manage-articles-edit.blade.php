...
@section('content')
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">编辑文章 <small></small></h1>
	<!-- end page-header -->
	<!-- begin panel -->
	<div class="panel panel-primary">
		...
		<div class="panel-body">
					...
					@endif
					<form class="form-horizontal" action="{{ route('articles.update',$article->id) }}" method="post" data-parsley-validate="true" name="update-form">
						@csrf
						@method('PUT')
