	...
	<div class="col-lg-9">
            ...
            <ul class="comment-list">
                <li>
                    ...
                    <div class="comment-container">
                        ...
                        <div class="comment-rating">
                            Like or Dislike: 
                            <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-up text-muted"></i> 154</a>
                            <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-down text-muted"></i> 112</a>
                        </div>
                        <!-- begin comment-list -->
                        <ul class="comment-list">
                            <li>
                                ...
                                <div class="comment-container">
                                    ...
                                    <div class="comment-rating">
                                        Like or Dislike: 
                                        <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-up text-muted"></i> 5</a> 
                                        <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-down text-muted"></i> 0</a>
                                    </div>
                                </div>
                ...
                <li>
                    ...
                    <div class="comment-container">
                        ...
                        <div class="comment-rating">
                            Like or Dislike: 
                            <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-up text-muted"></i> 2</a> 
                            <a href="#" class="m-l-10 text-inverse d-inline-block width-50 text-left"><i class="fa fa-thumbs-down text-muted"></i> 0</a>
                        </div>
                    </div>
                    <!-- end comment-container -->
        ...
        <div class="section-container">
            ...
            <form class="form-horizontal" action="" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-md-10 offset-md-2">
                        <button type="submit" class="btn btn-inverse btn-lg width-300">Submit Comment</button>
                    </div>
                </div>
            </form>
        </div>
