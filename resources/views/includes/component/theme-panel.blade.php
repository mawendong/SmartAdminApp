...
<div class="theme-panel theme-panel-lg">
	...
	<div class="theme-panel-content">
		...
		<div class="row m-t-10">
			<div class="col-6 control-label text-inverse f-w-600">头部栏固定</div>
		...
		<div class="row m-t-10">
			<div class="col-6 control-label text-inverse f-w-600">头部栏颜色反转</div>
			<div class="col-6 d-flex">
				<div class="custom-control custom-switch ml-auto">
		...
		<div class="row m-t-10">
			<div class="col-6 control-label text-inverse f-w-600">侧边栏网固定</div>
			<div class="col-6 d-flex">
				<div class="custom-control custom-switch ml-auto">
		...
		<div class="row m-t-10">
			<div class="col-6 control-label text-inverse f-w-600">侧边栏网格化</div>
			<div class="col-6 d-flex">
				<div class="custom-control custom-switch ml-auto">
		...
		<div class="row m-t-10">
			<div class="col-md-6 control-label text-inverse f-w-600">侧边栏渐变</div>
		...
		<div class="row m-t-10">
			<div class="col-md-12">
				<!-- <a href="#" class="btn btn-inverse btn-block btn-rounded" target="_blank"><b>帮助中心</b></a> -->
				<a href="javascript:;" class="btn btn-default btn-block btn-rounded" data-click="reset-local-storage"><b>复位样式配置</b></a>
			</div>
		</div>
	</div>
</div>
