		...
		<ul class="nav">
			...
			<li>
				...
				<ul class="nav nav-profile">
					<li><a href="{{ route('user.profile.edit') }}"><i class="fa fa-cog"></i> 设置</a></li>
					<li><a href="{{ route('user.avatar.edit') }}"><i class="fa fa-image"></i> 更换头像</a></li>
					<li><a href="javascript:;"><i class="fa fa-pencil-alt"></i> 反馈问题</a></li>
					<li><a href="javascript:;"><i class="fa fa-question-circle"></i> 帮助</a></li>

					<li><a href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();"><i class="fa fa-lock"></i> 退出</a></li>
